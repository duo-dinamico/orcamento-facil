...
class RegisterLogin(tk.Toplevel):
    def __init__(self, parent, presenter) -> None:
        ...
        username_popup = tk.StringVar()
        password_popup = tk.StringVar()
        ...
        entry_username_popup = ttk.Entry(self, textvariable=username_popup)
        ...
        entry_password_popup = ttk.Entry(self, textvariable=password_popup, show="*")
