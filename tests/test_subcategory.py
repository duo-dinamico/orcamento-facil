...
def test_success_read_subcategory_by_name(db_session, valid_subcategory):
    _ = valid_subcategory
    subcategory = db_session.model_subcategory.read_subcategory_by_name("validSubCategory")
...
def test_success_read_category_list_by_category_id(db_session, valid_subcategory):
    _ = valid_subcategory
    category_list = db_session.model_subcategory.read_subcategories_by_category_id(category_id=1)
...
def test_success_read_subcategories(db_session, valid_subcategory):
    _ = valid_subcategory
    subcategory_list = db_session.model_subcategory.read_subcategories()
...
def test_success_subcategory_creation(db_session, valid_category):
    _ = valid_category
    subcategory = db_session.model_subcategory.create_subcategory(category_id=1, name="newSubCategory")
...
def test_error_read_subcategory_by_name(db_session, valid_subcategory):
    _ = valid_subcategory
    subcategory_id = db_session.model_subcategory.read_subcategory_by_name("wrongSubCategory")
...
def test_error_read_subcategory_list_by_category_id_category_invalid(db_session, valid_subcategory):
    _ = valid_subcategory
    category_list = db_session.model_subcategory.read_subcategories_by_category_id(category_id=2)
...
def test_error_subcategory_creation_category_invalid(db_session):
    subcategory = db_session.model_subcategory.create_subcategory(category_id=1, name="validSubCategory")
