...
def test_success_create_user_subcategory(db_session, valid_user, valid_subcategory):
    _ = valid_user
    _ = valid_subcategory
    user_subcategory = db_session.create_user_subcategory(user_id=1, subcategory_id=1)
...
def test_success_read_user_subcategory_multiple_args(db_session, valid_user_subcategory):
    ...
    user_subcategory = db_session.read_user_subcategories_multiple_args(user_id=1, subcategory_id=1)
...
def test_success_read_user_subcategory_single_arg(db_session, valid_user_subcategory):
    _ = valid_user_subcategory
    user_subcategory = db_session.read_user_subcategories_single_arg(key="user_id", value=1)
...
def test_success_read_user_subcategory_from_user(db_session, valid_user_subcategory):
    _ = valid_user_subcategory
    user_subcategory = db_session.read_user_subcategories_by_user(user_id=1)
...
def test_success_delete_user_subcategory(db_session, valid_user_subcategory):
    _ = valid_user_subcategory
    deleted_rows = db_session.delete_user_subcategory(subcategory_id=1)
...
def test_error_user_does_not_exist(db_session, valid_subcategory):
    _ = valid_subcategory
    user_subcategory = db_session.create_user_subcategory(user_id=2, subcategory_id=1)
...
def test_error_subcategory_does_not_exist(db_session, valid_user):
    _ = valid_user
    user_subcategory = db_session.create_user_subcategory(user_id=1, subcategory_id=2)
...
def test_error_read_user_subcategory_multiple_args_wrong_arg(db_session):
    user_subcategory = db_session.read_user_subcategories_multiple_args(fish=1)
...
def test_error_read_user_subcategory_single_arg_wrong_arg(db_session):
    user_subcategory = db_session.read_user_subcategories_single_arg(key="fish", value=1)
...
def test_error_read_user_subcategory_from_user(db_session, valid_user_subcategory):
    _ = valid_user_subcategory
    user_subcategory = db_session.read_user_subcategories_by_user(user_id=2)
